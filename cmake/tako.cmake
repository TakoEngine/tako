function(tako_setup target)
    if (DEFINED EMSCRIPTEN)
        set(CMAKE_EXECUTABLE_SUFFIX ".js" PARENT_SCOPE)
				...
				set_target_properties(${target} PROPERTIES LINK_FLAGS "-sUSE_WEBGPU -sEXPORTED_RUNTIME_METHODS=ccall -sALLOW_MEMORY_GROWTH=1 -sASYNCIFY")
...
function(tako_assets_dir target dir)
    ...
    message(${dir})
    if (DEFINED EMSCRIPTEN)
		set_target_properties(${target} PROPERTIES LINK_FLAGS "--preload-file ${dir}@ -sPTHREAD_POOL_SIZE=navigator.hardwareConcurrency-1 -sUSE_WEBGPU -sEXPORTED_RUNTIME_METHODS=ccall -sALLOW_MEMORY_GROWTH=1 -sASYNCIFY -sEXPORTED_FUNCTIONS=_malloc,_main -sUSE_FREETYPE")
    else()
